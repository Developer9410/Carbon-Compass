...
import { ThumbsUp, MessageCircle, Share, Award, Filter, Image, Send, Flag, Trash2 } from 'lucide-react';
    ...
    <div className="container mx-auto max-w-6xl px-4">
      ...
      >
        ...
        <p className="text-gray-600">
          Connect with other members, share your sustainability journey, and get inspired.
        </p>
      </motion.div>
            ...
            <form onSubmit={handlePostSubmit}>
              <div className="flex items-start mb-4">
                ...
                <textarea
                  ...
                  placeholder="Share your sustainability journey or ask a question..."
              ...
              <div className="flex items-center justify-between">
                ...
                <button 
                  ...
                  className={`btn ${
                    newPostContent.trim() ? 'btn-primary' : 'bg-gray-300 text-gray-500 cursor-not-allowed'
                  }`}
                >
                  Post
                </button>
              ...
              filteredPosts.map((post) => (
                ...
                >
                  ...
                  <div className="flex justify-between mb-4">
                    ...
                    {post.category !== 'general' && (
                      <span className={`text-xs px-2 py-0.5 rounded-full ${
                        post.category === 'achievement' ? 'bg-green-100 text-green-800' :
                  ...
                  <div className="flex items-center justify-between pt-4 border-t">
                    ...
                    >
                      <ThumbsUp size={16} className={post.likedBy.includes(user?.id || '') ? 'fill-primary' : ''} />
                      ...
                      <div className="flex items-start">
                        ...
                        <div className="flex-1 relative">
                          <textarea
                            ...
                            className="input w-full h-20 pr-12 resize-none"
                          />
                          <button 
        ...
        <div className="lg:col-span-1 space-y-8">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            <h2 className="text-xl font-semibold mb-4 flex items-center">
              <Award className="w-5 h-5 text-primary mr-2" /> Leaderboard
            </h2>
              ...
              {mockLeaderboard.map((leader, index) => (
                <div key={leader.id} className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    />
                    <div>
                      <h3 className="font-medium text-sm">{leader.name}</h3>
                      <p className="text-xs text-gray-500">
                        {leader.reductionPercent}% reduction
                      </p>
                    </div>
                  </div>
            ...
            <div className="mt-4 pt-4 border-t">
              <button className="text-primary text-sm font-medium hover:underline flex items-center justify-center w-full">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <div className="space-y-4">
              <div className="border rounded-lg p-4">
                <h3 className="font-medium mb-2">Meatless Monday Challenge</h3>
                ...
                <p className="text-xs text-gray-500 mt-2">
                  21 participants • Ends in 14 days
                </p>
              </div>
              
              <div className="border rounded-lg p-4">
                <h3 className="font-medium mb-2">Zero Waste Week</h3>
                <div className="flex justify-between items-center text-sm mb-2">
                  <span className="text-gray-600">Progress:</span>
                ...
                <p className="text-xs text-gray-500 mt-2">
                  47 participants • Ends in 4 days
                </p>
              </div>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <ul className="space-y-2 text-sm text-gray-700">
              ...
              <li className="flex items-start">
                <span className="text-primary mr-2">•</span>
                Share authentic experiences and achievements
              </li>
              <li className="flex items-start">
                <span className="text-primary mr-2">•</span>
                Post constructive and relevant content
              </li>
              <li className="flex items-start">
                <span className="text-primary mr-2">•</span>
