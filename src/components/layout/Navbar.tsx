...
const Navbar: React.FC<NavbarProps> = ({ toggleSidebar }) => {
  ...
  const { user, totalFootprint, isLoggedIn, logout } = useApp();
                ...
                {isLoggedIn ? (
                  <div className="flex items-center space-x-2">
                    ...
                    <button
                      ...
                      className="text-sm text-gray-800 hover:text-red-600 px-2 py-1 rounded transition-colors"
                    >
                      Logout
                    </button>
                  </div>
                  ...
                  <div className="flex items-center space-x-2">
                    <Link
                      to="/login"
                      className="text-sm font-medium text-gray-800 hover:text-primary px-3 py-2 rounded-md transition-colors"
                    >
                      Login
                    </Link>
                    <Link
